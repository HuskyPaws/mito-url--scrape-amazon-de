...
# Streamlit app title
st.title("Amazon Product Data Scraper - DE")
                ...
                for element in response_json.get('data', []):
                    ...
                    # Handle detail bullets
                        ...
                        if not element.get('error') and element.get('results'):
                            ...
                            # German variations for manufacturer and model number
                            manufacturer_terms = ["Manufacturer", "Hersteller"]
                            model_terms = ["Item model number", "Modellnummer", "Artikelnummer"]
                    ...
                    # Handle tech specs table
                        ...
                        if element.get('results'):
                            ...
                            # Check both English and German terms
                            manufacturer_terms = ["Manufacturer", "Hersteller"]
                            model_terms = ["Item model number", "Modellnummer", "Artikelnummer"]
